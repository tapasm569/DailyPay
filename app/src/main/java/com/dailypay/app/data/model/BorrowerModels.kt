...
data class Borrower(
    ...
    @SerialName("village_city") val villageCity: String? = null,
    @SerialName("post_office") val postOffice: String? = null,
    @SerialName("police_station") val policeStation: String? = null,
    val dist: String? = null,
    @SerialName("aadhaar_card_url") val aadhaarCardUrl: String? = null,
    @SerialName("pan_card_url") val panCardUrl: String? = null,
